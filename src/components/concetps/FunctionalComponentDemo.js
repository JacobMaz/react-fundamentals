        ...
        <Container className="main">
            <Row>
                <Col xs="12">
                    ...
                    <dl>
                        <dt>Can use state</dt>
                        <dd>With the 'useState' hook, functional componens can now both render a display to the page and update the information to be shown.</dd>
                        <dt>No 'this' keyword</dt>
                        <dd>Older class components use 'this, functional components have no 'this' object.</dd>
                        <dt>Can use effects</dt>
                        <dd>With the 'useEffect' hook, functional ocmponents can perfom side effect with any props or state changes.</dd>
                        <dt>return()</dt>
